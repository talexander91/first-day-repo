...
// loops through each number in the array and triples it then adds it to a new array
const tripledArray = originalArray.map(data => data * 3);

// TODO: Describe how map is working in the example below. What will the value of oddOrEven be?
//filters through the array to determine whether number is odd or even and returns message as such.
